...
void Shape::draw() const {
    ...
    switch (this->type) {
        ...
        case FILLED_BOX:
            gameScreenBuffer->drawFilledBox(
                p1.x, p1.y, p2.x, p2.y, this->color);
            break;

        case FILLED_CIRCLE:
            gameScreenBuffer->drawFilledCircle(
                p1.x, p1.y, this->radius, this->color);
            break;
        ...
        case DOTTED_LINE:
            gameScreenBuffer->drawDottedLine(
                p1.x, p1.y, p2.x, p2.y, this->color);
            break;

        case DOTTED_ELLIPSE:
            gameScreenBuffer->drawDottedEllipse(
                p1.x, p1.y, p2.x, p2.y, this->color);
            break;
