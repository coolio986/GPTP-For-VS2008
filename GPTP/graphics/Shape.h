...
class Shape {
   public:
    ...
    void setCircle(int       x,
                   ...
                   ColorId   color,
                   CoordType coordType);
    void setFilledBox(int       left,
                      int       top,
                      int       right,
                      int       bottom,
                      ColorId   color,
                      CoordType coordType);
    void setFilledCircle(int       x,
                         int       y,
                         int       radius,
                         ColorId   color,
                         CoordType coordType);
    void setEllipse(int       left,
                    int       top,
                    int       right,
                    int       bottom,
                    ColorId   color,
                    CoordType coordType);
    void setDottedLine(int       x1,
                       int       y1,
                       int       x2,
                       int       y2,
                       ColorId   color,
                       CoordType coordType);
    void setDottedEllipse(int       left,
                          int       top,
                          int       right,
                          int       bottom,
                          ColorId   color,
