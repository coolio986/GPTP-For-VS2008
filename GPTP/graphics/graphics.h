...
const ColorId BLUE =
    165;  // Player 2 color					(0xA5)
const ColorId TEAL =
    159;  // Player 3 color					(0x9F)
const ColorId PURPLE =
    164;  // Player 4 color					(0xA4)
const ColorId ORANGE =
    179;  // Player 5 color					(0xB3)
const ColorId BROWN =
    19;  // Player 6 color					(0x13)
const ColorId WHITE =
    255;  // Player 7 color					(0xFF)
...
const static ColorId standardColors[] = {RED,
                                         BLUE,
                                         TEAL,
                                         PURPLE,
                                         ORANGE,
