...
void __declspec(naked) transferUnitUpgradesToPlayerWrapper() {
    ...
    hooks::transferUnitUpgradesToPlayerHook(
        sourceUnit, targetPlayerId, researchUpgradeFunc);
...
void __declspec(naked) transferUnitTechToPlayerWrapper() {
    ...
    hooks::transferUnitTechToPlayerHook(
        sourceUnit, targetPlayerId, researchTechFunc);
