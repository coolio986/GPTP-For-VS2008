...
/// To use, add the following code to the gameOn() function in
...
namespace offsets {
const u32 SightStructArrayRef =
    0x00480709;  // The pointer to the SightStruct array must be injected here
const u32 InitializeSightValues =
    0x0042AD60;  // The internal function responsible for setting up the array
}  // namespace offsets
...
// static_assert(sizeof(SightStruct) == 28, "The size of the SightStruct
