...
namespace OrderId {
enum Enum {
    Die = 0x00,  /**< Causes the unit to die. Normal units run the death iscript
                  * animation, while hallucinated units have the sound/sprite
                  * spawned and then are removed.
    ...
    TurretGuard = 0x04, /**< Attacking unit turret guard.
                         * Default Requirements: Unit is a subunit. Allow on
                         * hallucinated units. */
    BunkerGuard =
        0x05,    /**< Transport building guard. Set when a building picks up a
                  * unit.    Default Requirements: Unit must be a Terran Bunker. */
    Move = 0x06, /**< Unit move. Ignores enemies on way to destination.
                  * Default Requirements: Unit is able to move. Allow on
                  * hallucinated units. */
    ReaverStop = 0x07,       /**< Stop order for the reaver.
                              * Default Requirements: Unit must be Reaver/Warbringer.
                              * Allow on hallucinated units. */
    ...
    AttackFixedRange = 0x0B, /**< Attack for an immobile unit. Lurker attack.
                              * Default Requirements: Unit responds to battle
                              * orders. Allow on hallucinated units. */
    ...
    AttackMove = 0x0E, /**< Unit move, attack enemies along path to target.
                        ...
                        * hallucinated units. */
    InfestMine1 =
        0x0F,        /**< Ran when a unit is being infested.
    ...
    Powerup1 = 0x11, /**< Unknown. Speculated to be a Powerup being built order.
                      * Default Requirements: Unused. */
    TowerGuard =
        0x12, /**< Building tower guard.
               * Default Requirements: Unit must be either Photon Cannon,
               * Missile Turret, Sunken Colony, or Spore Colony. */
    TowerAttack =
        0x13, /**< Building tower attack.
               * Default Requirements: Unit must be either Photon Cannon,
               * Missile Turret, Sunken Colony, Spore Colony, Floor Gun Trap,
               * Left Wall Missile Trap, Left Wall Flame Trap, Right Wall Flame
               * Trap, Right Wall Missile Trap, */
    VultureMine =
        0x14,            /**< Spidermine idle order.
    ...
    TurretAttack = 0x16, /**< Mobile Unit Turret attack.
                          * Default Requirements: Must be subunit. Allow on
                          * hallucinated units. */
    Nothing2 = 0x17,     /**< Do nothing, next order.
                          * Default Requirements: Allow on hallucinated units. */
    Nothing3 = 0x18, /**< Unknown, used when a unit is changing state between
                      * siege <-> normal. Default Requirements: Unused. */
    ...
    BuildProtoss1 =
        0x1F, /**< Full Protoss Building order.
               * Default Requirements: Unit must be Protoss Probe. */
    BuildProtoss2 =
        0x20, /**< Creates the Protoss Building.
               * Default Requirements: Unit must be Protoss Probe. */
    ConstructingBuilding =
        0x21,          /**< SCV is building.
                        * Default Requirements: Unit must be Terran SCV. */
    ...
    Train = 0x26,      /**< Training Unit.
                        * Default Requirements: Unused. */
    RallyPoint1 =
        0x27, /**< Rally to Visible Unit. Causes units to follow the selected
               * unit. Default Requirements: Unit is able to set Rally Point. */
    RallyPoint2 =
        0x28, /**< Rally to tile.
               * Default Requirements: Unit is able to set Rally Point. */
    ZergBirth =
        0x29,               /**< Unit is being born.
    ...
    Build5 = 0x2E,          /**< Nydus canal exit build order.
                             * Default Requirements: Unit must be Zerg Nydus Canal and
                             * must not have exit. */
    Enternyduscanal = 0x2F, /**< Enter/transport through nydus canal
                             * Default Requirements: Unused. */
    BuildSelf2 = 0x30,      /**< Protoss Building being built order.
                             * Default Requirements: Unused. */
    Follow = 0x31, /**< Move to/with unit or building. Causes units to load into
                    * transports or enter nydus canal or recharge shields.
                    * Default Requirements: Unit is able to move. Allow on
                    * hallucinated units. */
    Carrier = 0x32, /**< Idle command for the carrier.
                     * Default Requirements: Unit must be Carrier/Gantrithor.
                     * Allow on hallucinated units. */
    CarrierIgnore1 =
        0x33,           /**< Carrier move command. Ignores enemies
                         * Default Requirements: Unit must be Carrier/Gantrithor or
                         * Reaver/Warbringer. Allow on hallucinated units. */
    CarrierStop = 0x34, /**< Carrier stop command. Runs idle.
                         * Default Requirements: Unit must be
                         * Carrier/Gantrithor. Allow on hallucinated units. */
    CarrierAttack1 =
        0x35, /**< Generic Carrier attack command.
               * Default Requirements: Unit must be Carrier/Gantrithor. Allow on
               * hallucinated units. */
    CarrierAttack2 =
        0x36, /**< Move to attack shrouded building.
               * Default Requirements: Unit must be Carrier/Gantrithor. Allow on
               * hallucinated units. */
    CarrierIgnore2 =
        0x37,             /**< Unknown. Possibly a secondary move.
                           * Default Requirements: Unit must be Carrier/Gantrithor or
                           * Reaver/Warbringer. Allow on hallucinated units. */
    ...
    ReaverHold = 0x3E,    /**< Reaver hold position.
                           * Default Requirements: Unit must be Reaver/Warbringer.
                           * Allow on hallucinated units. */
    TrainFighter = 0x3F,  /**< Training subunit(scarab, interceptor). Causes all
                           * interceptors within a carrier to be healed when not
                           * attacking.  Default Requirements: Unused. */
    StrafeUnit1 = 0x40,   /**< Interceptor move and attack.
                           * Default Requirements: Unit must be Protoss
                           * Interceptor. Allow on hallucinated units. */
    ...
    RechargeShields1 = 0x42, /**< Unit recharge shields.
                              * Default Requirements: Unused. */
    Rechargeshields2 =
        0x43, /**< Shield Battery, recharge shield cast on unit or ground. Unit
               * runs recharge shields 1, shield battery runs shield battery. If
               * cast on ground, recharges all units within rechargeable radius.
    ...
    Return = 0x45,          /**< Interceptor return to parent.
                             * Default Requirements: Unit must be a Worker (has harvest
                             * orders). */
    DroneLand = 0x46,       /**< Drone landing order. Used when building.
                             * Default Requirements: Unit must be Zerg Drone. */
    BuildingLand = 0x47,    /**< Building land order.
                             * Default Requirements: Unit must be a building(can
                             * lift off) that is lifted off. */
    BuildingLiftoff = 0x48, /**< Begin Building Liftoff
                             * Default Requirements: Unit must be a building(can
                             * lift off) that is on the ground. */
    DroneLiftoff = 0x49,    /**< Begin Drone liftoff
                             * Default Requirements: Unit must be Zerg Drone. */
    Liftoff =
        0x4A,            /**< Unit is lifting off.
    ...
    HarvestGas1 = 0x51, /**< Move to harvest gas.
                         * Default Requirements: Unit must be a Worker (has
                         * harvest orders). */
    ...
    HarvestMinerals2 = 0x56, /**< Can harvest minerals(one unit per field).
                              * Default Requirements: Unit must be a Worker (has
                              * harvest orders). */
    MiningMinerals = 0x57,   /**< Harvesting minerals. Runs iscript to spawn
                              * weapon.   Default Requirements: Unused. */
    ...
    Harvest5 = 0x5B,         /**< Harvest Interrupt /B recharge shields.
                              * Default Requirements: Unused. */
    EnterTransport =
        0x5C,               /**< Move/enter a transport.
                             * Default Requirements: Allow on Hallucinated Units. */
    Pickup1 = 0x5D,         /**< Transport Idle command.
                             * Default Requirements: Unit must be Transport(Can carry
                             * units) or Zerg Overlord. */
    ...
    InitCreepGrowth = 0x65, /**< Start Spreading Creep.
                             * Default Requirements: Unit must be
                             * Hatchery/Lair/Hive or Creep Colony. */
    SpreadCreep = 0x66, /**< Spreads creep. If it is a larva producer, runs that
                         * order also. Default Requirements: Blank. */
    StoppingCreepGrowth =
        0x67, /**< Stops creep growth.
               * Default Requirements: Unit must be Sunken/Spore Colony. */
    GuardianAspect =
        0x68,             /**< Unused, Morph 1 is used for unit morphing.
    ...
    HoldPosition2 = 0x6B,          /**< Attacking Unit hold position.
                                    * Default Requirements: Unit is able to Hold
                                    * Position. Allow on hallucinated units. */
    HoldPosition3 =
        0x6C,                /**< Queen Hold position.
                              * Default Requirements: Unit must be Zerg Queen/Matriarch. */
    ...
    NukeTrain = 0x7C, /**< Silo Idle
                       * Default Requirements: Unused. */
    NukeLaunch =
        0x7D,         /**< Launch for nuclear missile.
                       * Default Requirements: Unit must be Terran Nuclear Missile. */
    NukePaint = 0x7E, /**< Move to and set nuke target.
                       * Default Requirements: Unit must be Terran Ghost. */
    NukeUnit =
        0x7F, /**< Nuke the ground location of the unit.
               * Default Requirements: Unit must be Terran Nuclear Missile. */
    NukeGround =
        0x80, /**< Nuke ground.
               * Default Requirements: Unit must be Terran Nuclear Missile. */
    NukeTrack =
        0x81,           /**< Ghost order during nuke.
                         * Default Requirements: Unit must be Terran Nuclear Missile. */
    InitArbiter = 0x82, /**< Run nearby cloaking.
                         * Default Requirements: Unit must be Protoss
                         * Arbiter/Danimoth. Allow on Hallucinated units. */
    CloakNearbyUnits =
        0x83,         /**< Cloak non arbiters within range.
                       * Default Requirements: Unit must be Protoss Arbiter/Danimoth. */
    PlaceMine = 0x84, /**< Place spider mine.
                       * Default Requirements: Unused. */
    Rightclickaction =
        0x85,           /**< right click, sets correct order based on target.
                         * Default Requirements: Allow on Hallucinated units. */
    SapUnit = 0x86,     /**< Suicide Attack Unit.
                         * Default Requirements: Unit must be Zerg infested Terran.
                         * Allow on Hallucinated units. */
    SapLocation = 0x87, /**< Suicide Attack tile.
                         * Default Requirements: Unit must be Zerg infested
                         * Terran. Allow on Hallucinated units. */
    HoldPosition4 =
        0x88,                  /**< Suicide Hold Position.
                                * Default Requirements: Unit must be Zerg Infested Terran or Zerg
                                * Scourge. Allow on Hallucinated units. */
    Teleport = 0x89,           /**< Recall(units within range of target pos).
                                * Default Requirements: Unused. */
    TeleporttoLocation = 0x8A, /**< Causes units to teleport when being
                                * recalled. Default Requirements: Unused. */
    ...
    CTFCOP2 = 0x9B,    /**< Unknown? Reset COP?
                        * Default Requirements: Unit must be Zerg Flag Beacon,
                        * Terran Flag Beacon, or Protoss Flag Beacon. */
    ComputerAI = 0x9C, /**< AI Control.
                        * Default Requirements: Unused. */
    AtkMoveEP = 0x9D,  /**< AI Attack Move?
                        * Default Requirements: Unit is able to move. Allow on
                        * Hallucinated units. */
    HarassMove = 0x9E, /**< Aggressive Attack Move? Units won't give up on a
                        * target. If they see it, they will attack it, even
                        * worse than attack move. Might be a computer attack
                        * move? Default Requirements: Unused. */
    AIPatrol =
        0x9F, /**< Moves units to the center of the current area that they are
               * at? Not sure if the spacing is meant to allow for detectors to
               * cover an area or not. Default Requirements: Unused. */
    ...
    Neutral = 0xA2,       /**< Neutral Unit idle.
                           * Default Requirements: Unused. */
    ComputerReturn =
        0xA3, /**< Return computer units to defensive position? Was seen
               * returning units that had followed a unit outside of a base and
               * killed it. Default Requirements: Unused. */
    InitPsiProvider = 0xA4, /**< Init Psi Provider. Adds to some kind of linked
                             * list. Default Requirements: Unused. */
    SelfDestrucing =
        0xA5,         /**< Remove unit.
                       * Default Requirements: Unit must be Protoss Scarab. */
    Critter = 0xA6,   /**< Critter idle.
                       * Default Requirements: Unit must be Rhynadon, Bengalaas,
                       * Ragnasaur, Scantid, Kakaru, or Ursadon. Allow on
                       * hallucinated units. */
    HiddenGun = 0xA7, /**< Trap idle order.
                       * Default Requirements: Unit must be Floor Gun Trap, Left
                       * Wall Missile Trap, Left Wall Flame Trap, Right Wall
                       * Missile Trap, or Right Wall Flame Trap. */
    OpenDoor =
        0xA8, /**< Opens the door.
               * Default Requirements: Unit must be Left Upper Level Door, Right
               * Upper Level Door, Left Pit Door, or Right pit Door. */
    CloseDoor =
        0xA9, /**< Closes the door.
               * Default Requirements: Unit must be Left Upper Level Door, Right
               * Upper Level Door, Left Pit Door, or Right pit Door. */
    HideTrap =
        0xAA, /**< Trap return to idle.
               * Default Requirements: Unit must be Floor Missile Trap, Floor
               * Gun Trap, Left Wall Missile Trap, Left Wall Flame Trap, Right
               * Wall Missile Trap, or Right Wall Flame Trap. */
    RevealTrap =
        0xAB,             /**< Trap attack.
                           * Default Requirements: Unit must be Floor Missile Trap, Floor
                           * Gun Trap, Left Wall Missile Trap, Left Wall Flame Trap, Right
    ...
    Disabledoodad = 0xAD, /**< Disable Doodad State.
                           * Default Requirements: Unused. */
    Warpin = 0xAE, /**< Unused. Left over from unit warp in which now exists in
                    * Starcraft 2. Default Requirements: Unused. */
    ...
    HealMove = 0xB1,   /**< Attack move command for the Terran Medic.
                        * Default Requirements: Unit must be Terran Medic. */
    MedicHoldPosition =
        0xB2, /**< Holds Position for Terran Medics, heals units within range.
               * Default Requirements: Unit must be Terran Medic. */
    ...
    CastDisruptionWeb = 0xB5, /**< Cast Spell: Disruption Web.
                               * Default Requirements: Unused. */
    CastMindControl =
        0xB6,                 /**< Mind Control Cast on Target.
